...
<html>
    ...
    <body>
        ...
        <div class="main">
            <h1 style="background-color: #3F3F3F; color: white; padding: 10px; margin: 0px;" align="center">Authorisation </h1>
            <div style="background: white; border: black; padding: 10px; margin: 0px;" align="center" dir="ltr">
                ...
                <form name="f" action="/j_spring_security_check" method="POST" style="background: white;">
                    <table width="274px">
                        <tr>
                            <td>Login: </td>
